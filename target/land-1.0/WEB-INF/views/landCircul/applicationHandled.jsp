...
<div id="toolbar">
	<jksb:hasAutority authorityId="011">
		<a href="#" id ="applGdButton" class="easyui-linkbutton" data-options="iconCls:'pic_183',plain:true,disabled:true" >归档</a>
	</jksb:hasAutority>
	<jksb:hasAutority authorityId="011">
...
$('#applDatagrid').datagrid({
    url:"${ctx}/landCirculation/getAllApplication/Handled",
    method:'get',
    pagination:true,
    singleSelect:true,
    columns:[[
...
function applSelectChange(index,row){ 		// 选择行事件 通用。
	var selectedNum = $('#applDatagrid').datagrid('getSelections').length;
	if(selectedNum==1){
		...
		$("#applEditButton").linkbutton("disable");
	}
}
