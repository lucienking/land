...
<script type="text/javascript" src="../static/js/basemapinfo.js" ></script>
<script type="text/javascript" src="../static/js/map/map-selfEconomy.js"></script>
 <script>
...
<div id="cc"  class="easyui-layout" data-options="fit: true">
    ...
    <div class="grid-header" style="border-top:1px solid #95B8E7;">选择农场</div>
    	...
    	<div>图层控制</div>
		<div id="tocDiv"></div>	       
		<div id="Statistics" class="grid-header" style="border-top:1px solid #95B8E7;">地块统计信息</div>
		...
		<table id="search" width="100%">
			<tr>
				<td>地块编号</td>
				<td colspan="2">
				<input type="hidden" id="farmcode_input" name="farmcode" value="" class="conditions">
				<input id ="dkbh_input" type="text" name="DKBH" class="conditions"/></td>
			</tr>
			<tr>
				<td>户主</td>
			...
			<tr>
			<td></td>
			<td><a href="#" onClick="landSearch();" id = "search" class="easyui-linkbutton">搜索</a></td></tr>
		</table>	
    </div>
