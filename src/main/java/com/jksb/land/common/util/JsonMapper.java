...
public class JsonMapper {
	 ...
	 * 构造Collection类型.
	 */
	public JavaType contructCollectionType(@SuppressWarnings("rawtypes") Class<? extends Collection> collectionClass, Class<?> elementClass) {
	 ...
	 * 为False时时使用Enum的name()函数來读写Enum, 默认为False.
