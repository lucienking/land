...
<div id="toolbar">
	<jksb:hasAutority authorityId="011">
		<a href="#" id ="checkButton" class="easyui-linkbutton" data-options="iconCls:'pic_140',plain:true,disabled:true" >审批申请</a>
	</jksb:hasAutority>
	<jksb:hasAutority authorityId="011">
...
$('#applDatagrid').datagrid({
    url:"${ctx}/landCirculation/getAllApplication/Handling",
    method:'get',
    pagination:true,
    singleSelect:true,
    columns:[[
...
function applSelectChange(index,row){ 		// 选择行事件 通用。
	...
	if(selected.circulStatus =="CHECKING")
		$("#checkButton").linkbutton("enable");
	else $("#checkButton").linkbutton("disable");
