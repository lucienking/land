...
<link href="<spring:url value="/static/My97DatePicker/skin/WdatePicker.css"/>" rel="stylesheet">
<link href="<spring:url value="/static/styles/landContract/contract.css?r=4"/>" rel="stylesheet">
...
<script type="text/javascript" src="<spring:url value="/static/jquery-easyui/jquery.easyui.min.js"/>"></script>
<script type="text/javascript" src="<spring:url value="/static/jquery-easyui/locale/easyui-lang-zh_CN.js"/>"></script>
...
<script type="text/javascript" src="<spring:url value="/static/js/landContract/contractAdd.js?r=5"/>"></script>
<script type="text/javascript" src="<spring:url value="/static/js/landContract/customValidate.js"/>"></script>
<script type="text/javascript" src="<spring:url value="/static/uploadify/jquery.uploadify.js" />"></script>
...
<form action="<spring:url value="/landContract/addInner"/>" method="post" onsubmit="return formSubmit(this);">
<div id="layoutNorth" data-options="region:'north',split:false,collapsible:false">
...
<p align="right">     </p>
<p align="right">合同编号：<input id="contractFarm" name="contractFarm" value="${fn:replace(farmName, '农场','') }" class="inputClass" type="text" readonly="readonly">场字[<select id="contractYear" name="contractYear"><option>${year }</option></select>]    <input id="contractCode" name="contractCode" class="inputClass" type="text">    号 </p>
<p align="right">&nbsp;</p>
<p id="mainTitle" align="center"><strong>海南省国营${farmName }</strong> <br />
  <strong>内部土地承包合同书 </strong></p>
<p align="center"><strong>&nbsp;</strong></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<!-- <p align="center">发  包  方：海南省国营东昌农场<br />
  承  包  方：<input id="" name="" class="inputClass" type="text"></p> -->
<br clear="all" />
<p>&nbsp;</p>
<p>发  包  方：<input id="partyA" name="partyA" class="inputClass" type="text" value="海南省国营${farmName }" readonly="readonly"> （以下简称甲方） </p>
<p>法定代表人：<input id="representativeA" name="representativeA" class="inputClass" type="text" value="${representativeA }" readonly="readonly"><br />
  <br />
  承  包  方：<input id="partyB" name="partyB" class="inputClass easyui-validatebox" required="true" type="text"> （以下简称乙方） </p>
<p>身份证号：<input id="partyBIDNumber" name="partyBIDNumber" class="inputClass easyui-validatebox" required="true" data-options="validType:'idcard'" type="text"> </p>
<p>现住址：<input id="partyBAddress" name="partyBAddress" class="inputClass" type="text"> </p>
<p>&nbsp;</p>
<p>根据《中华人民共和国合同法》、《中华人民共和国土地管理法》、《海南经济特区土地管理条例》等有关法律、法规和海南省相关政策及《海南省国营东昌农场农业用地规范管理实施办法》的规定，甲、乙双方本着平等、自愿、有偿的原则，就海南省国营东昌农场土地承租事宜，经双方协商一致，订立本合同。 <br />
  ...
  甲方自愿将其坐落于国营<input id="belongFarm" name="belongFarm" class="inputClass" type="text" value="${farmName }" readonly="readonly">的<input id="areaOfLand" name="areaOfLand" class="inputClass" type="text" value="0" readonly="readonly">亩土地（详见下表）承包给乙方从事农业生产经营活动。 </p>
<p>&nbsp;</p>
<p><input type="button" value="添加地块" onclick="addRegionTr();"></p>
...
<thead>
  <tr>
    ...
    <td width="89" rowspan="2"><p align="center"><strong>收费标准（元/亩•年） </strong></p></td>
    <td width="75" rowspan="2"><p align="center"><strong>收费</strong><br />
      ...
      <strong>（元） </strong></p></td> -->
      <td width="43" rowspan="2"><p align="center"><strong>操作 </strong></p></td>
  </tr>
  <tr>
...
<tr>
    <td width="634" colspan="11" valign="top"><p><strong>承包土地的用途：<input id="landPurpose" name="landPurpose" class="inputClass" type="text" value="农业生产" readonly="readonly" style="width:120px;text-align: left;"> </strong></p></td>
  </tr>
  <tr>
    <td width="634" colspan="11" valign="top"><p><strong>合计：面积<span id="spAreaSum">0</span>亩，<!-- 基本地价收费总额<input id="baseRental" name="baseRental" class="noneBorder" type="text" value="0" readonly="readonly">元，阶梯地价递增总额<input id="increaseRental" name="increaseRental" class="noneBorder" type="text" value="0" readonly="readonly">元， -->应缴金额：<span id="spMoneySum">0</span>元 </strong></p></td>
  </tr>
</table>
<p><strong>&nbsp;</strong></p>
...
<input id="endDate" name="endDate" type="hidden">
  土地承包期限为<input id="timeLimit" name="timeLimit" class="inputClass easyui-validatebox" data-options="validType:['number','lte[\'int\',30]','checkAgeLimit']" type="text" onblur="caculateEndDate();">年，自<input id="startYear" class="inputClass" type="text" onblur="caculateEndDate();">年<input id="startMonth" class="inputClass" type="text" onblur="caculateEndDate();">月<input id="startDay" class="inputClass" type="text" onblur="caculateEndDate();">日起至<input id="endYear" class="inputClass" type="text" readonly="readonly">年<input id="endMonth" class="inputClass" type="text" readonly="readonly">月<input id="endDay" class="inputClass" type="text" readonly="readonly"">日止（土地承包期限不得超过30年，不得超过承包方的法定退休年龄，居民参照职工退休年龄执行）。 <br />
  ...
  （二）土地承包费：<input id="money" name="money" class="inputClass" type="text" readonly="readonly">元，大写：<input id="wan" name="wan" class="inputClass" type="text" readonly="readonly">万<input id="qian" name="qian" class="inputClass moneyCn" type="text" readonly="readonly"> 仟<input id="bai" name="bai" class="inputClass moneyCn" type="text" readonly="readonly"> 佰<input id="shi" name="shi" class="inputClass moneyCn" type="text" readonly="readonly"> 拾<input id="yuan" name="yuan" class="inputClass moneyCn" type="text" readonly="readonly"> 元<input id="jiao" name="jiao" class="inputClass moneyCn" type="text" readonly="readonly"> 角<input id="fen" name="fen" class="inputClass moneyCn" type="text" readonly="readonly"> 分。 <br />
  （三）土地承包费每<input id="increaseCycle" name="increaseCycle" class="inputClass" type="text">年递增<input id="increasePercentage" name="increasePercentage" class="inputClass" type="text">%。 <br />
...
<p>8.因国家、地方政府、农垦改革或甲方建设需要，乙方应当同意甲方收回或调整承包土地，在接到甲方通知之日起30天内搬迁、清理青苗及地上附着物，依法享有青苗及地上附着物补偿。 <br />
  ...
  （七）本合同签订后，甲方与<input id="terminationPartyB" name="terminationPartyB" class="inputClass" type="text">签订的原土地承包合同书同时终止执行。 <br />
  （八）双方约定的其他事项： <br />
  <input id="remarks" name="remarks" class="inputClass" type="text">。 </p>
  <p id="pFileUpload"><input id="file_upload" type="file" name="file_upload" multiple="true" /></p>
<p>甲方（盖章）：                      乙方（签名捺印）： <br />
  法定代表人（签名）：                联系方式：<input id="partyBContact" name="partyBContact" class="inputClass" type="text"></p>
<p>签订时间：<input id="signingDate" name="signingDate" class="inputClass" type="text" onClick="WdatePicker({dateFmt:'yyyy年MM月dd日',readOnly:true})"> </p>
    </div>
    </form>
</div>
</body>
